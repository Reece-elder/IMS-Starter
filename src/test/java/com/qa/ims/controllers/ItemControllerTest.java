...
public class ItemControllerTest {
	...
	public void testCreate() {
		final double COST = 12.50;
		final String NAME = "testitem";
		final Item created = new Item(COST, NAME);
...
//		Mockito.verify(dao, Mockito.times(1)).create(created);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, 15.50, "testReadAllItem"));
	...
	public void testUpdate() {
		Item updated = new Item(1L, 13.35, "testUpdateItem");
